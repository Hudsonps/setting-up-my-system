...
- [Setting up my work platform](#setting-up-my-work-platform)
  - [1. **Xcode CommandLine Tools**](#1-xcode-commandline-tools)
  - [2. **Keyboard**](#2-keyboard)
    - [2.1. **Increasing the key repeat speed**](#21-increasing-the-key-repeat-speed)
  - [3. **Package Manager: Homebrew**](#3-package-manager-homebrew)
  - [4. **Terminal: iTerm2**](#4-terminal-iterm2)
    - [4.1. **Installing iTerm2**](#41-installing-iterm2)
    - [4.2. **Setting up a color theme for iTerm2**](#42-setting-up-a-color-theme-for-iterm2)
      - [4.2.1. My Personal Color Theme Recommendations](#421-my-personal-color-theme-recommendations)
      - [4.2.2. Optional: Bulk-removing color themes from iTerm2](#422-optional-bulk-removing-color-themes-from-iterm2)
  - [5. **Shell: ZSH**](#5-shell-zsh)
    - [5.1. **Installing ZSH**](#51-installing-zsh)
      - [5.1.1. **Making MacOS use the Homebrew zsh**](#511-making-macos-use-the-homebrew-zsh)
  - [6. **Version control: git**](#6-version-control-git)
    - [6.1. **Installing git (with Homebrew)**](#61-installing-git-with-homebrew)
    - [6.2. **Configuring git**](#62-configuring-git)
  - [7. **Framework to manage ZSH: OH-MY-ZSH**](#7-framework-to-manage-zsh-oh-my-zsh)
    - [7.1. **Installing OH-MY-ZSH**](#71-installing-oh-my-zsh)
    - [7.2. **Enabling autosuggestions and syntax highlighting on ZSH (through OH-MY-ZSH)**](#72-enabling-autosuggestions-and-syntax-highlighting-on-zsh-through-oh-my-zsh)
  - [8. **Setting a theme for ZSH with OH-MY-ZSH: Powerlevel10k (P10k)**](#8-setting-a-theme-for-zsh-with-oh-my-zsh-powerlevel10k-p10k)
    - [8.1. **Installing the Nerd Fonts**](#81-installing-the-nerd-fonts)
    - [8.2. **Enhancing Powerlevel10k**](#82-enhancing-powerlevel10k)
  - [9. **Virtual Environments Manager: miniconda**](#9-virtual-environments-manager-miniconda)
    - [9.1. **Installing miniconda**](#91-installing-miniconda)
  - [10. **Python**](#10-python)
    - [10.1. **Installing Python**](#101-installing-python)
    - [10.2. **Creating an environment from an environment file**](#102-creating-an-environment-from-an-environment-file)
    - [10.3. **Getting the list of all existing environments**](#103-getting-the-list-of-all-existing-environments)
    - [10.4. **Activating an environment**](#104-activating-an-environment)
    - [10.5. **Listing packages installed in an environment**](#105-listing-packages-installed-in-an-environment)
    - [10.6. **Deactivating an environment**](#106-deactivating-an-environment)
    - [10.7. Deleting an environment**](#107-deleting-an-environment)
  - [11. **Text Editor: Visual Studio Code (VSCode)**](#11-text-editor-visual-studio-code-vscode)
    - [11.1. **Installing VSCode**](#111-installing-vscode)
    - [11.2. **Calling VSCode via the command line**](#112-calling-vscode-via-the-command-line)
    - [11.3. **Integrating the VSCode terminal with ZSH**](#113-integrating-the-vscode-terminal-with-zsh)
    - [11.4. **Beautifying VSCode**](#114-beautifying-vscode)
    - [11.5. **Useful Extensions**](#115-useful-extensions)
  - [12. **Controlling environments with VSCode**](#12-controlling-environments-with-vscode)
  - [13. **Python Linters**](#13-python-linters)
    - [13.1. **Installing the Linters**](#131-installing-the-linters)
    - [13.2. **Using the Linters with VSCode**](#132-using-the-linters-with-vscode)
      - [13.2.1. **Enabling Linters on VSCode**](#1321-enabling-linters-on-vscode)
      - [13.2.2. **Adjusting the Linters verbosity in VSCode**](#1322-adjusting-the-linters-verbosity-in-vscode)
...
### 2.1. **Increasing the key repeat speed**
...
### 4.2. **Setting up a color theme for iTerm2**
...
#### 4.2.1. My Personal Color Theme Recommendations

- [Ayu](https://github.com/hwyncho/ayu-iTerm)

#### 4.2.2. Optional: Bulk-removing color themes from iTerm2
...
#### 5.1.1. **Making MacOS use the Homebrew zsh**
...
### 6.1. **Installing git (with Homebrew)**
...
## 7. **Framework to manage ZSH: OH-MY-ZSH**
...
### 7.2. **Enabling autosuggestions and syntax highlighting on ZSH (through OH-MY-ZSH)**
...
## 8. **Setting a theme for ZSH with OH-MY-ZSH: Powerlevel10k (P10k)**
...
## 9. **Virtual Environments Manager: miniconda**
...
### 10.2. **Creating an environment from an environment file**
...
### 10.3. **Getting the list of all existing environments**
...
### 10.4. **Activating an environment**
...
### 10.5. **Listing packages installed in an environment**
...
### 10.6. **Deactivating an environment**
...
### 10.7. Deleting an environment**

## 11. **Text Editor: Visual Studio Code (VSCode)**
...
### 11.3. **Integrating the VSCode terminal with ZSH**
...
## 12. **Controlling environments with VSCode**
...
### 13.2. **Using the Linters with VSCode**
...
#### 13.2.1. **Enabling Linters on VSCode**
...
#### 13.2.2. **Adjusting the Linters verbosity in VSCode**
